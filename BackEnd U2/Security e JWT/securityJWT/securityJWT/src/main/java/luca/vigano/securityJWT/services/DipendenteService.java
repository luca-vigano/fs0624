...
//    private Cloudinary cloudinaryUploader;
    ...
    public Dipendente finByEmail(String email){
        return this.dipendenteRepository.findByEmail(email).orElseThrow(()-> new NotFoundException("l'untente con la mail " + email + " non è stato trovato"));
    }
